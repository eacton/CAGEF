...
We are going to see how pipes work in conjunction with our first function, `filter()`. 
...
To get only Taxa that had OTUs at sites T_2_1 and T_2_10 using `dplyr`, you can use the following filter:
